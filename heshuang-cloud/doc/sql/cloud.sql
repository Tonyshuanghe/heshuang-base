...
CREATE database if NOT EXISTS `heshuang-framework` default character set utf8mb4 collate utf8mb4_unicode_ci;
USE `heshuang-framework`;
SET NAMES utf8mb4;
...
YC-Framework初始化数据
 */
INSERT INTO `yc_company`(`id`, `company_name`, `company_code`, `contact`, `phone`, `address`, `url`, `email`, `count`, `status`, `create_time`, `update_time`) VALUES (1, '油老板科技创新有限公司', '888888', '油老板', '保密', '中国', 'http://www.ycframework.com', 'youlaoban@163.com', 0, 1, '2021-09-20 11:55:45', '2021-09-20 11:55:48');
/*账号密码 admin/admin */
INSERT INTO `yc_user`(`id`, `user_name`, `password`, `email`, `phone`, `nick_name`, `company_id`, `sex`, `status`, `create_time`, `update_time`) VALUES ('f5799c7404a240f1b15bbad7bbd99b14', 'admin', '$2a$12$1o91wYWDY20eSphdJRkbTe2i/NH7PBKUO4LTnW8.o/TxtwfRc4Cmy', '15200740587@163.com', '15200740587', '油老板', 1, 0, 0, '2021-09-20 22:18:09', '2021-09-20 22:18:15');
INSERT INTO `heshuang-framework`.`yc_menu` (`id`, `menu_name`, `menu_key`, `menu_type`, `parent_id`, `menu_sort`, `status`) VALUES (1, 'admin', 'admin', '角色', 0, 1, 0);
INSERT INTO `heshuang-framework`.`yc_role_menu` (`role_id`, `menu_id`) VALUES ('admin', 1);
INSERT INTO `heshuang-framework`.`yc_role` (`id`, `role_key`, `role_name`, `status`, `create_time`, `update_time`) VALUES ('admin', 'admin', 'admin', 0, '2022-10-25 10:55:43', '2022-10-25 10:55:45');
INSERT INTO `heshuang-framework`.`yc_user_role` (`user_id`, `role_id`) VALUES ('f5799c7404a240f1b15bbad7bbd99b14', 'admin');
