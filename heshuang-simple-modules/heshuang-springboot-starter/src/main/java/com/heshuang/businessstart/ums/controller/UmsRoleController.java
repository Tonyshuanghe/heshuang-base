...
public class UmsRoleController {
    ...
    @ResponseBody
    public RestResult create(@RequestBody UmsRole role) {
    ...
    @ResponseBody
    public RestResult update(@PathVariable Long id, @RequestBody UmsRole role) {
        role.setId(id);
    ...
    @ResponseBody
    public RestResult delete(@RequestParam("ids") List<Long> ids) {
    ...
    @ResponseBody
    public RestResult<List<UmsRole>> listAll() {
    ...
    @ResponseBody
    public RestResult<Page<UmsRole>> list(@RequestParam(value = "keyword", required = false) String keyword,
    ...
    @ResponseBody
    public RestResult<List<UmsMenu>> listMenu(@PathVariable Long roleId) {
    ...
    @ResponseBody
    public RestResult<List<UmsResource>> listResource(@PathVariable Long roleId) {
    ...
    @ResponseBody
    public RestResult allocMenu(@RequestParam Long roleId, @RequestParam List<Long> menuIds) {
    ...
    @ResponseBody
    public RestResult allocResource(@RequestParam Long roleId, @RequestParam List<Long> resourceIds) {
