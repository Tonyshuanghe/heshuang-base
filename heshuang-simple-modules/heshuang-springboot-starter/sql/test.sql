...
CREATE TABLE `demo`  (
  `id` bigint NOT NULL,
  `is_flag` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1:正常|0:删除，默认值为1',
...
-- Records of demo
-- ----------------------------
INSERT INTO `demo` VALUES (1559831790837825536, 1, '2022-08-17 17:17:34', NULL, NULL);
INSERT INTO `demo` VALUES (1559831938770927616, 1, '2022-08-17 17:18:09', NULL, NULL);
INSERT INTO `demo` VALUES (1559832610278998016, 1, '2022-08-17 17:20:49', NULL, NULL);
INSERT INTO `demo` VALUES (1559832757226438656, 1, '2022-08-17 17:21:24', NULL, NULL);
INSERT INTO `demo` VALUES (1559833680665378816, 1, '2022-08-17 17:25:04', NULL, NULL);
INSERT INTO `demo` VALUES (1559833766216597504, 1, '2022-08-17 17:25:25', NULL, NULL);
INSERT INTO `demo` VALUES (1559834114306080768, 1, '2022-08-17 17:26:48', NULL, NULL);
INSERT INTO `demo` VALUES (1559835873221017600, 1, '2022-08-17 17:33:47', NULL, NULL);
INSERT INTO `demo` VALUES (1559837659461844992, 1, '2022-08-17 17:40:53', NULL, NULL);
INSERT INTO `demo` VALUES (1559843699498680320, 1, '2022-08-17 18:04:53', NULL, NULL);

-- ----------------------------
-- Table structure for demo_jpa
-- ----------------------------
DROP TABLE IF EXISTS `demo_jpa`;
...
-- Records of demo_jpa
-- ----------------------------
INSERT INTO `demo_jpa` VALUES (480321516932694016, 1, '2022-08-18 10:26:14', NULL, 0);
INSERT INTO `demo_jpa` VALUES (480335961054511104, 1, '2022-08-18 11:23:37', NULL, 0);
...
-- ----------------------------
INSERT INTO `ums_admin` VALUES (1, 'test', '$2a$10$NZ5o7r2E.ayT2ZoxgjlI.eJ6OEYqjH7INR/F.mXDbjZJi9HF0YCVG', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'test@qq.com', '测试账号', NULL, '2018-09-29 13:55:30', '2018-09-29 13:55:39', 1, NULL);
INSERT INTO `ums_admin` VALUES (3, 'admin', '$2a$10$Ob8CCM5k4JG9QyiaPeLrIOEhsLPEQCWmFoh05rCN1nyHjzXRmgWwq', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2019-04-20 12:45:16', 1, '19940831959');
...
INSERT INTO `ums_admin` VALUES (6, 'productAdmin', '$2a$10$6/.J.p.6Bhn7ic4GfoB5D.pGd7xSiD1a9M6ht6yO0fxzlKJPjRAGm', NULL, 'product@qq.com', '商品管理员', '只有商品权限', '2020-02-07 16:15:08', NULL, 1, NULL);
INSERT INTO `ums_admin` VALUES (7, 'orderAdmin', '$2a$10$UqEhA9UZXjHHA3B.L9wNG.6aerrBjC6WHTtbv1FdvYPUI.7lkL6E.', NULL, 'order@qq.com', '订单管理员', '只有订单管理权限', '2020-02-07 16:15:50', NULL, 1, NULL);
INSERT INTO `ums_admin` VALUES (10, 'ceshi', '$2a$10$RaaNo9CC0RSms8mc/gJpCuOWndDT4pHH0u5XgZdAAYFs1Uq4sOPRi', NULL, 'ceshi@qq.com', 'ceshi', NULL, '2020-03-13 16:23:30', NULL, 1, NULL);
...
CREATE TABLE `ums_admin_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1560160124058206209 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户登录日志表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ums_admin_login_log` VALUES (1552493961392160768, 3, '2022-07-28 11:19:39', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (1559851598541750272, 3, '2022-08-17 18:36:16', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (1560160124058206208, 3, '2022-08-18 15:02:15', '0:0:0:0:0:0:0:1', NULL, NULL);
...
CREATE TABLE `ums_role_menu_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 110 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台角色菜单关系表' ROW_FORMAT = DYNAMIC;
